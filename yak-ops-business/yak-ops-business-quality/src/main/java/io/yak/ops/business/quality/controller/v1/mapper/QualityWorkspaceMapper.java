...
/** HTTP mapping for monitor workspace projections. */
@Component
public class QualityWorkspaceMapper {
  private final QualityMonitorMapper monitorMapper;

  public QualityWorkspaceMapper(QualityMonitorMapper monitorMapper) {
  ...
  public QualityWorkspaceVO.MonitorWorkspace workspace(MonitorWorkspace value) {
    ...
    return new QualityWorkspaceVO.MonitorWorkspace(
        monitorMapper.detail(value.monitor()),
        monitorMapper.settings(value.settings()),
