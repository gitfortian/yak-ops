...
CREATE TABLE IF NOT EXISTS yak_realtime_job_definition (
  ...
  CONSTRAINT fk_realtime_definition_environment
...
CREATE TABLE IF NOT EXISTS yak_realtime_job_deployment (
  ...
  CONSTRAINT fk_realtime_deployment_definition
    FOREIGN KEY (definition_id) REFERENCES yak_realtime_job_definition(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS yak_realtime_job_event (
  ...
  CONSTRAINT fk_realtime_event_definition
    FOREIGN KEY (definition_id) REFERENCES yak_realtime_job_definition(id) ON DELETE CASCADE
);
