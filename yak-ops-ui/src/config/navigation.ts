...
export const appRoutes: readonly NavigationRoute[] = [
  ...
  { id: 'dashboard', menuCode: YAK_OPS_MENU_CODES.dashboard, mode: 'public', path: '/dashboard', title: '仪表盘', component: './data-analysis/dashboard', iconKey: 'insight', menuGroup: 'data-analysis', order: 10 },
  ...
  { id: 'dataset-management', menuCode: YAK_OPS_MENU_CODES.datasetManagement, mode: 'public', path: '/dataset', title: '数据集', component: './data-analysis/dataset', iconKey: 'database', menuGroup: 'data-analysis', order: 20 },
  ...
  { id: 'digital-screen', menuCode: YAK_OPS_MENU_CODES.digitalScreen, mode: 'public', path: '/digital-screen', title: '数字化大屏', component: './data-analysis/digital-screen', iconKey: 'insight', menuGroup: 'data-analysis', order: 30 },
  ...
  { id: 'data-development', menuCode: YAK_OPS_MENU_CODES.dataDevelopment, mode: 'one', permission: 'data-development:read', path: '/data-development', title: '开发任务', component: './development/data-development', iconKey: 'api', menuGroup: 'development', order: 10 },
  ...
  { id: 'data-development-execution', menuCode: YAK_OPS_MENU_CODES.dataDevelopmentExecution, mode: 'one', permission: 'data-development:read', path: '/data-development/executions', title: '运行记录', component: './development/data-development/executions', iconKey: 'report', menuGroup: 'development', order: 30 },
  ...
  { id: 'resource-management', menuCode: YAK_OPS_MENU_CODES.resourceManagement, mode: 'one', permission: 'resource:view', path: '/resource-management', title: '文件资源', component: './resources/resource-management', iconKey: 'database', menuGroup: 'resources', order: 10 },
