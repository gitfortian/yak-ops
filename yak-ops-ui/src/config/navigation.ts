...
export const appRoutes: readonly NavigationRoute[] = [
  ...
  { id: 'data-service-debug', mode: 'one', permission: 'data-service:runtime', path: '/data-service/debug', title: 'API 调试', component: './data-service/debug', iconKey: 'api', menuGroup: 'data-service', order: 20 },
